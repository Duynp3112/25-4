                    ...
                    <div class="col-lg-10 m-b30">
                        <div class="widget-box">
                            <div class="widget-inner">
                                <form action="addcontract" method="post" class="edit-profile m-b30">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="ml-auto">
                                            </div>
                                        ...
                                        <div class="form-group col-3">
                                            <label class="col-form-label">Hợp đồng của khách hàng</label>
                                            <div>
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <div>
                                                <input class="form-control" type="date" value="" name="start">
                                            </div>
                                        </div>
