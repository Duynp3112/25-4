                                    ...
                                    <tbody>
                                        <c:forEach items="${listC}" var="i">
                                            <tr>
                                                ...
                                                <td class="p-2">
                                                    <c:if test="${sessionScope.acc == 'ADMIN' || sessionScope.acc == 'EMPLOYEE' && sessionScope.pos == 'Quản lý'}">
                                                        <a href="/cms/userprofile?&userid=${i.getUserId()}" class="btn" ><i class="ti-pencil-alt"></i></a>
                                                        </c:if>
