                        ...
                        <div class="widget-box">
                            <div class="row">
                                <div class="col-8" class="wc-title" style="display: flex">
                                    <h4  style="margin-left: 20px">Danh sách tương tác</h4>

                                </div>
                                <div class="col-4"> 
                                    <c:if test="${sessionScope.acc == 'CUSTOMER'}">
                                        <a class="btn " href="/cms/addinteraction">Thêm +</a>
                                    </c:if>
                                </div>
                            </div>
                                ...
                                <table class="">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-bottom p-3" style="min-width: 100px;">Tình huống</th>
                                            <th class="border-bottom p-3" style="min-width: 150px;">Phản hồi</th>
                                            <th class="border-bottom p-3" style="min-width: 150px;">Tên nhân viên</th>
                                            <th class="border-bottom p-3" style="min-width: 150px;">Thời gian</th>
                                            ...
                                            <c:choose>
                                                <c:when test="${sessionScope.acc == 'EMPLOYEE' || sessionScope.acc == 'ADMIN'}">
                                                    <tr>
                                                        ...
                                                        <td>${i.schedule}</td>
                                                        <td class="p-3">
                                                            <a href="/cms/updatetransaction?&interactionId=${i.interactionId}" class="btn" ><i class="ti-pencil-alt"></i></a>
                                                            <a href="#" class="btn"  onclick="deleteUser('${i.interactionId}')"><i class="fa fa-trash-o"></i></a>
                                                        </td>
                                                    </tr>
                                                </c:when>
                                                <c:when test="${sessionScope.acc == 'CUSTOMER' && sessionScope.FullName == i.userId}">
                                                    <tr>
                                                        <td>${i.interactionId}</td>
                                                        <td>${i.userId}</td>
                                                        <td>${i.scenario}</td>
