...
public class CustomerDao extends BaseDao {
    ...
    public void delete(String HDID) {
        String sql = "DELETE FROM GiaoDich_NhanVien_HopDong_Users WHERE HD_ID = ?";
    ...
    public void insertGiaoDichNhanVienHopDongUsers(String id, String employeeID, String customerID) {
        try {
            String query = "INSERT INTO GiaoDich_NhanVien_HopDong_Users (NhanVienID, Giaodich_ID, UserID, HD_ID) VALUES (?, ?, ?, ?)";
            pstm = connection.prepareStatement(query);
            pstm.setString(1, employeeID);
            pstm.setString(2, "GD001");
