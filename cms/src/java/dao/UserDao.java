...
public class UserDao extends BaseDao {
    ...
    public User getUser(String userID) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                user = new User(userId, fullName, gender, dob, email, phone, address, username, password);
            }
        } catch (SQLException e) {
            e.printStackTrace();
        } finally {
    ...
    public boolean addUser(String username, String password) {
        try {
            ...
            String roleQuery = "SELECT RoleID FROM Quyen WHERE RoleName = 'Employee'";
            ...
            if (rs.next()) {
                ...
                System.err.println("Không tìm thấy RoleID cho role 'Employee'.");
                return false;
            }
